...
declare -a fn_calls=(
                    "fit_params(5, @fit_3params_softmax_10k)"
                    "fit_params(5, @fit_5params_softmax_10k)"
                    "fit_params(5, @fit_4params_UCB_10k)"
                    "fit_params(5, @fit_6params_UCB_10k)"
                    "fit_params(5, @fit_2params_Thompson_10k, 3000, 10)"
                    "fit_params(5, @fit_4params_Thompson_10k, 3000, 10)"
                     )
