function ABC_Thompson(eps, nsess)
    ...
    while true
        ...
        try
            ...
            tic
            [ex, agent] = run(params, @choose_Thompson, nsess);
            ...
            if d < eps
                ...
                filename = sprintf('ABC_Thompson_eps=%.2f_nsess=%d_params=[%s].mat', eps, nsess, sprintf('%.5f_', params));
                filename
