% test for thompson by seeing whether farter targets have faster learning
%
...
for rat = 1:nrats
    ...
    [r, p, x, y, b] = fig_jumps2_single(ex_rats(rat), rat, nrats);
...
fprintf('fitglme (learning) slope = %f (negative is policy gradient), p = %f, F(%d,%d) = %f\n', H * beta, p, DF1, DF2, F);
